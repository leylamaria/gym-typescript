...
import HomePageText from "@/assets/homePageTextgray.png";
import HomePageGraphic from "@/assets/homeGraphicFilter.png";
...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-white py-10 md:h-full md:pb-0">
      ...
      <div className="mx-auto w-5/6 items-center justify-center md:flex md:h-5/6 md:mt-28">
        {/*MAIN HEADER*/}
